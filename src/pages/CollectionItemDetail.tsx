            ...
            <div className="relative bg-black/40 backdrop-blur-2xl rounded-[2rem] shadow-2xl border border-white/10 p-8 ring-1 ring-white/5">
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-white/60 text-sm">Professional grading details</p>
                </div>
              </div>
            ...
            <div className="relative bg-black/40 backdrop-blur-2xl rounded-[2rem] shadow-2xl border border-white/10 p-8 ring-1 ring-white/5">
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-white/60 text-sm">Rarity & distribution stats</p>
                </div>
              </div>

              <div className="space-y-4">
                <div className="flex justify-between items-center p-3 rounded-xl bg-white/5 backdrop-blur-xl border border-white/10">
                  <span className="text-white/70 font-medium">Total PSA Population</span>
                ...
                {psaCard.cardId?.psaGrades && (
                  <div className="space-y-3">
                    <p className="text-sm text-white/80 font-medium mb-3">Grade Distribution:</p>
                      ...
                      {Object.entries(psaCard.cardId.psaGrades)
                        ...
                        .map(([grade, count]) => {
                          ...
                          return (
                            ...
                            >
                              <span className="font-medium text-sm">Grade {gradeNumber}</span>
                              <span className={`font-bold text-sm ${isCurrentGrade ? 'text-blue-400' : 'text-white'}`}>
                                {count}
                              </span>
                            </div>
                          );
                    ...
                    <div className="mt-4 pt-4 border-t border-white/10">
                      <div className="flex justify-between items-center p-3 rounded-xl bg-gradient-to-r from-green-500/10 to-emerald-500/10 border border-green-500/20">
                        <span className="text-green-300 font-medium">Total Population</span>
          ...
          <div className="relative bg-black/40 backdrop-blur-2xl rounded-[2rem] shadow-2xl border border-white/10 p-8 ring-1 ring-white/5">
            <div className="flex items-center space-x-4 mb-6">
              ...
              <div>
                ...
                <p className="text-white/60 text-sm">Ungraded card information</p>
              </div>
            </div>
          ...
          <div className="relative bg-black/40 backdrop-blur-2xl rounded-[2rem] shadow-2xl border border-white/10 p-8 ring-1 ring-white/5">
            <div className="flex items-center space-x-4 mb-6">
              ...
              <div>
                ...
                <p className="text-white/60 text-sm">Unopened product details</p>
              </div>
            </div>
  ...
  return (
    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/3 right-20 w-1 h-1 bg-purple-400/30 rounded-full animate-pulse" style={{animationDelay: '1s'}}></div>
        <div className="absolute bottom-1/4 left-1/3 w-1.5 h-1.5 bg-pink-400/20 rounded-full animate-pulse" style={{animationDelay: '2s'}}></div>
      </div>
        ...
        {loading && (
          <div className="flex items-center justify-center min-h-screen">
            <div className="text-center">
              ...
              <p className="text-white/80 text-lg">Loading premium details...</p>
            </div>
          </div>
        )}
        ...
        {error && !item && (
          <div className="flex items-center justify-center min-h-screen">
            <div className="text-center p-8 rounded-3xl bg-red-500/10 backdrop-blur-xl border border-red-500/20">
              ...
              <h3 className="text-xl font-bold text-red-400 mb-2">Item Not Found</h3>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap items-center gap-4 mt-6">
                        <div className="px-4 py-2 rounded-xl bg-white/10 backdrop-blur-xl border border-white/20 text-white/90">
                          <span className="text-sm font-medium">Set: {getSetName()}</span>
                        </div>
                        <div className="px-4 py-2 rounded-xl bg-green-500/20 backdrop-blur-xl border border-green-500/30 text-green-300">
                          <span className="text-sm font-bold">{item.myPrice || '0'} kr</span>
                        </div>
                        <div className={`px-4 py-2 rounded-xl backdrop-blur-xl border ${item.sold ? 'bg-red-500/20 border-red-500/30 text-red-300' : 'bg-emerald-500/20 border-emerald-500/30 text-emerald-300'}`}>
                          <span className="text-sm font-medium">{item.sold ? 'Sold' : 'Available'}</span>
                        </div>
                      </div>
                    </div>
                ...
                <div className="relative bg-black/40 backdrop-blur-2xl rounded-[2rem] shadow-2xl border border-white/10 p-8 ring-1 ring-white/5 h-full flex flex-col">
                  <div className="flex items-center space-x-4 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-white/60 text-sm">Core item information</p>
                    </div>
                  </div>

                  <div className="space-y-6 flex-1">
                    <div className="flex justify-between items-center p-3 rounded-xl bg-white/5 backdrop-blur-xl border border-white/10">
                      <span className="text-white/70 font-medium">Current Value</span>
                      <span className="font-bold text-green-400 text-lg">
                        {item.myPrice || '0'} kr
                      </span>
                    </div>
                    <div className="flex justify-between items-center p-3 rounded-xl bg-white/5 backdrop-blur-xl border border-white/10">
                      <span className="text-white/70 font-medium">Date Added</span>
                    ...
                    <div className="flex justify-between items-center p-3 rounded-xl bg-white/5 backdrop-blur-xl border border-white/10">
                      ...
                      <span className={`font-bold px-3 py-1 rounded-lg ${item.sold ? 'bg-red-500/20 text-red-300 border border-red-500/30' : 'bg-emerald-500/20 text-emerald-300 border border-emerald-500/30'}`}>
                    ...
                    <div className="flex justify-between items-center p-3 rounded-xl bg-white/5 backdrop-blur-xl border border-white/10">
                      <span className="text-white/70 font-medium">Images</span>
                    ...
                    <div className="flex justify-between items-center p-3 rounded-xl bg-white/5 backdrop-blur-xl border border-white/10">
                      <span className="text-white/70 font-medium">Condition</span>
                      <span className="font-bold text-yellow-400">
                        {'grade' in item ? `Grade ${item.grade}` : 'condition' in item ? item.condition : 'Sealed'}
                      </span>
                    </div>
                  </div>
                ...
                <div className="relative bg-black/40 backdrop-blur-2xl rounded-[2rem] shadow-2xl border border-white/10 p-8 ring-1 ring-white/5">
                  ...
                  <div className="flex items-center space-x-4 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-white/60 text-sm">High-resolution imagery</p>
                    </div>
                  </div>
                ...
                <div className="relative bg-black/40 backdrop-blur-2xl rounded-[2rem] shadow-2xl border border-white/10 p-8 ring-1 ring-white/5">
                  <div className="flex items-center space-x-4 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-white/60 text-sm">Price tracking & history</p>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 pt-6 border-t border-white/10">
                    <div className="flex items-center space-x-3 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-white/60 text-xs">Adjust market value</p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <button 
                        ...
                        disabled={!newPrice.trim() || isNaN(parseInt(newPrice, 10)) || parseInt(newPrice, 10) <= 0 || parseInt(newPrice, 10) === Math.round(item?.myPrice || 0)}
              ...
              <div className="mb-8 relative overflow-hidden">
                ...
                <div className="relative bg-black/40 backdrop-blur-2xl rounded-[2rem] shadow-2xl border border-white/10 p-8 ring-1 ring-white/5">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                      <div className="flex justify-between items-center p-3 rounded-xl bg-white/5 backdrop-blur-xl border border-white/10">
                        <span className="text-white/70 font-medium">Sale Price</span>
                        <span className="font-bold text-green-400 text-lg">
                          {item.saleDetails.actualSoldPrice} kr
                        </span>
                      </div>
                      <div className="flex justify-between items-center p-3 rounded-xl bg-white/5 backdrop-blur-xl border border-white/10">
                        <span className="text-white/70 font-medium">Payment</span>
                        <span className="font-medium text-blue-300">
                          {item.saleDetails.paymentMethod}
                        </span>
                      </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between items-center p-3 rounded-xl bg-white/5 backdrop-blur-xl border border-white/10">
                        <span className="text-white/70 font-medium">Date Sold</span>
                        <span className="font-medium text-cyan-300">
                          {item.saleDetails.dateSold
                            ? new Date(item.saleDetails.dateSold).toLocaleDateString()
                            : 'N/A'}
                      ...
                      <div className="flex justify-between items-center p-3 rounded-xl bg-white/5 backdrop-blur-xl border border-white/10">
                        <span className="text-white/70 font-medium">Buyer</span>
                        <span className="font-medium text-yellow-300">
                          {item.saleDetails.buyerFullName || 'N/A'}
                        </span>
                      </div>
                      <div className="flex justify-between items-center p-3 rounded-xl bg-white/5 backdrop-blur-xl border border-white/10">
                        <span className="text-white/70 font-medium">Tracking</span>
