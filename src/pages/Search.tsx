...
const Search: React.FC = () => {
  ...
  const handleSuggestionClick = (suggestion: { cardName?: string; name?: string } | string) => {
    const searchTerm = typeof suggestion === 'string' ? suggestion : (suggestion.cardName || suggestion.name || '');
          ...
          <div className="relative z-10">
            <div className="flex items-center mb-6">
              ...
              <div>
                ...
                <p className="text-slate-600 font-medium">Find your perfect Pokémon cards and products</p>
              </div>
            </div>
            ...
            >
              <span className="group-hover:scale-105 transition-transform duration-300">Search</span>
            </button>
            ...
            >
              ...
              <span className="font-semibold text-slate-700 group-hover:text-slate-900">Filters</span>
            </button>
          </form>
          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 relative overflow-hidden">
            ...
            <div className="p-8 relative z-10">
              <SearchResultsCards
                ...
                sortBy={sortBy}
                onSortChange={(newSortBy) => setSortBy(newSortBy as 'relevance' | 'name' | 'popularity')}
                currentPage={1}
                totalPages={1}
                onPageChange={(page) => {
          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 relative overflow-hidden">
            ...
            <div className="p-16 text-center relative z-10">
              ...
              <p className="text-slate-600 font-medium mb-8 max-w-lg mx-auto text-lg leading-relaxed">
                Search through thousands of premium Pokémon cards, sets, and products. Use the search bar above to get started.
              </p>
