...
import { Calendar, DollarSign, Filter, Package, Plus, X } from 'lucide-react';
          ...
          <div className="bg-zinc-900/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-zinc-700/20 p-10 relative overflow-hidden group">
            ...
            <div className="relative z-10 flex items-center justify-between">
              <div>
                ...
                <p className="text-xl text-slate-600 dark:text-zinc-400 dark:text-zinc-300 font-medium leading-relaxed">
              ...
              <div className="flex items-center space-x-3">
                <Button
                  ...
                  variant="outline"
                  className="text-gray-700 dark:text-zinc-300 dark:text-zinc-200 border-gray-300 dark:border-zinc-600 dark:border-zinc-600 hover:border-gray-400 dark:hover:border-zinc-500"
                >
                  🔄 Refresh
                </Button>
                <Button
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="group bg-zinc-900/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 relative overflow-hidden border border-zinc-700/20 hover:scale-105 transition-all duration-500 hover:shadow-slate-500/20">
              ...
              <div className="flex items-center relative z-10">
                ...
                <div className="ml-6">
                  <p className="text-sm font-bold text-slate-600 dark:text-zinc-400 dark:text-zinc-300 tracking-wide uppercase mb-1">
                    Draft Auctions
                  </p>
          ...
          <div className="bg-zinc-900/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-zinc-700/20 p-8 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-6">
                ...
                {statusFilter && (
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    className="text-slate-600 dark:text-zinc-400 dark:text-zinc-300 hover:text-slate-800 dark:hover:text-zinc-200 border-slate-300 dark:border-zinc-600 dark:border-zinc-600 hover:border-slate-400 dark:hover:border-zinc-500"
                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div>
                  <label className="block text-sm font-bold text-slate-700 dark:text-zinc-300 dark:text-zinc-200 mb-3 tracking-wide">
                    Status
                  </label>
                  <Select
                    value={statusFilter}
