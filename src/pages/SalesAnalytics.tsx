...
const SalesAnalytics: React.FC = () => {
  ...
  const pieChartData = Object.entries(categoryBreakdown).map(([category, data]) => ({
            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <input
                  ...
                  onChange={(e) => setDateRangeInput(prev => ({ ...prev, startDate: e.target.value }))}
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4 flex-1">
                ...
                <p className="text-2xl font-bold text-gray-900">{formatCurrency(kpis.totalProfit)}</p>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4 flex-1">
                ...
                <p className="text-2xl font-bold text-gray-900">{formatPercentage(kpis.averageMargin)}</p>
              ...
              {graphData.length > 0 ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="mt-2 text-gray-500">
                    Sales data over time will appear here.
                  </p>
                </div>
              )}
            </div>
                  ...
                  {sales.slice(0, 10).map((sale) => {
                    ...
                    return (
                      <tr key={sale.id} className="hover:bg-gray-50">
                        ...
                        <td className={`px-6 py-4 whitespace-nowrap text-sm font-medium ${profitColor}`}>
