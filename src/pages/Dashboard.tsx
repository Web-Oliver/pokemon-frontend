      ...
      <div className="relative z-10 p-8">
        ...
        <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-blue-600 rounded-3xl shadow-2xl text-white p-10 relative overflow-hidden border border-white/20">
          ...
          <div className="relative z-10">
            <h1 className="text-4xl font-bold mb-3 tracking-wide drop-shadow-lg">Welcome to PokéCollection</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="group bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 relative overflow-hidden border border-white/20 hover:scale-105 transition-all duration-300 hover:shadow-purple-500/20">
            ...
            <div className="flex items-center relative z-10">
              ...
              <div className="ml-6">
                <p className="text-sm font-bold text-slate-600 tracking-wide uppercase">Total Items</p>
                <p className="text-3xl font-bold text-slate-900 group-hover:text-indigo-700 transition-colors duration-300">--</p>
              </div>
            </div>
          </div>
          ...
          <div className="group bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 relative overflow-hidden border border-white/20 hover:scale-105 transition-all duration-300 hover:shadow-emerald-500/20">
            ...
            <div className="flex items-center relative z-10">
              ...
              <div className="ml-6">
                ...
                <p className="text-3xl font-bold text-slate-900 group-hover:text-emerald-700 transition-colors duration-300">--</p>
              </div>
            </div>
          </div>
          ...
          <div className="group bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 relative overflow-hidden border border-white/20 hover:scale-105 transition-all duration-300 hover:shadow-purple-500/20">
            ...
            <div className="flex items-center relative z-10">
              ...
              <div className="ml-6">
                ...
                <p className="text-3xl font-bold text-slate-900 group-hover:text-purple-700 transition-colors duration-300">--</p>
              </div>
            </div>
          </div>
          ...
          <div className="group bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 relative overflow-hidden border border-white/20 hover:scale-105 transition-all duration-300 hover:shadow-amber-500/20">
            ...
            <div className="flex items-center relative z-10">
              ...
              <div className="ml-6">
                <p className="text-sm font-bold text-slate-600 tracking-wide uppercase">Watching</p>
                <p className="text-3xl font-bold text-slate-900 group-hover:text-amber-700 transition-colors duration-300">--</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="p-8 relative z-10">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className="text-lg font-bold text-slate-900 mb-2 group-hover:text-indigo-700 transition-colors duration-300">Add New Item</p>
              ...
              >
                ...
                <p className="text-lg font-bold text-slate-900 mb-2 group-hover:text-emerald-700 transition-colors duration-300">View Analytics</p>
              ...
              >
                ...
                <p className="text-lg font-bold text-slate-900 mb-2 group-hover:text-purple-700 transition-colors duration-300">Browse Collection</p>
