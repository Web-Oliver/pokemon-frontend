  ...
  const renderContent = () => (
    <div className={`relative z-10 text-center ${sizeClasses.padding}`}>
      ...
      <div className="relative mb-12">
        <div className={`${sizeClasses.iconContainer} bg-gradient-to-r from-violet-500/20 to-pink-500/20 rounded-full mx-auto flex items-center justify-center border-4 border-violet-400/30 backdrop-blur-sm`}>
      ...
      {/* Title */}
      <h3 className={`font-bold bg-gradient-to-r from-violet-400 to-pink-400 bg-clip-text text-transparent mb-4 ${sizeClasses.title}`}>
        {getDefaultMessage()}
      </h3>

      {/* Subtitle */}
      <p className={`text-violet-300/80 mb-8 leading-relaxed ${sizeClasses.subtitle}`}>
...
export const DbaEmptyState: React.FC<{
  ...
  <UnifiedDbaEmptyState {...props} variant="standard" />
);
...
export const DbaEmptyStateCosmic: React.FC<{
  ...
  <UnifiedDbaEmptyState {...props} variant="cosmic" />
);
