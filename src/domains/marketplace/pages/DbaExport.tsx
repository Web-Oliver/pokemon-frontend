...
const DbaCosmicBackground = lazy(
  () =>
    import(
      /* webpackChunkName: "dba-heavy" */ '../components/DbaCosmicBackground'
    )
);
...
const DbaHeaderActions = lazy(
  () =>
    import(
      /* webpackChunkName: "dba-heavy" */ '../components/DbaHeaderActions'
    )
);
const DbaExportConfiguration = lazy(
  () =>
    import(
      /* webpackChunkName: "dba-heavy" */ '../components/DbaExportConfiguration'
    )
);
const DbaExportSuccess = lazy(
  () =>
    import(
      /* webpackChunkName: "dba-heavy" */ '../components/DbaExportSuccess'
    )
);
const DbaItemsWithTimers = lazy(
  () =>
    import(
      /* webpackChunkName: "dba-heavy" */ '../components/DbaItemsWithTimers'
    )
);
const DbaItemsWithoutTimers = lazy(
  () =>
    import(
      /* webpackChunkName: "dba-heavy" */ '../components/DbaItemsWithoutTimers'
    )
);
