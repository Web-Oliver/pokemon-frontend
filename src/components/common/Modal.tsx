  ...
  return (
    <div className='fixed inset-0 z-50 overflow-y-auto'>
      ...
      <div className='flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0'>
        <div
          className='fixed inset-0 bg-gradient-to-br from-zinc-950/90 via-zinc-900/80 to-zinc-950/90 backdrop-blur-xl transition-all duration-500 ease-out'
          onClick={onClose}
        />
        ...
        <div className='absolute inset-0 overflow-hidden pointer-events-none'>
          <div className='absolute top-1/4 left-1/4 w-2 h-2 bg-zinc-400/20 rounded-full animate-pulse'></div>
        ...
        <div
          className={`inline-block align-bottom bg-zinc-900/95 backdrop-blur-2xl rounded-3xl px-4 pt-5 pb-4 text-left overflow-hidden shadow-2xl transform transition-all duration-500 ease-out scale-95 hover:scale-100 sm:my-8 sm:align-middle ${maxWidthClass} sm:w-full sm:p-8 border border-zinc-700/30 relative group shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] hover:shadow-[0_25px_50px_-12px_rgba(6,182,212,0.25)]`}
        >
          ...
          <div className='relative z-10'>
            ...
            {title && (
              <div className='flex items-center justify-between mb-6'>
                <h3 className='text-2xl font-bold text-zinc-100 bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent'>
                  {title}
                </h3>
                <button
                  onClick={onClose}
                  className='p-2 text-zinc-400 hover:text-zinc-200 hover:bg-zinc-800/50 rounded-2xl focus:outline-none focus:ring-2 focus:ring-cyan-500/50 transition-all duration-300 group/close backdrop-blur-sm hover:shadow-lg hover:scale-105 active:scale-95'
                >
          ...
          <div className='absolute inset-0 bg-gradient-to-r from-transparent via-cyan-200/10 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 ease-out pointer-events-none'></div>

          {/* Premium sparkle effect */}
          <div className='absolute top-4 right-4 w-1 h-1 bg-cyan-400 rounded-full animate-pulse opacity-60'></div>
          <div className='absolute bottom-8 left-8 w-0.5 h-0.5 bg-blue-400 rounded-full animate-pulse opacity-40 delay-500'></div>
        </div>
      </div>
    </div>
  );
