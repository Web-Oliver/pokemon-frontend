    ...
    <div className="w-full">
      ...
      >
        ...
        <div className="p-10 text-center relative z-10">
          ...
          <div className={`mx-auto w-20 h-20 mb-6 rounded-2xl flex items-center justify-center transition-all duration-500 ${
            disabled 
          ...
          <p className={`text-xl font-bold mb-3 tracking-wide ${
            disabled ? 'text-slate-400' : dragActive ? 'text-indigo-700' : 'text-slate-700 group-hover:text-indigo-700'
          ...
          <div className={`inline-flex items-center space-x-4 px-6 py-3 rounded-2xl text-xs font-semibold tracking-wide transition-all duration-300 ${
            disabled 
              ? 'bg-slate-100 text-slate-300' 
        ...
        <div className="mt-8">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="px-4 py-2 bg-gradient-to-r from-indigo-100 to-purple-100 rounded-2xl border border-indigo-200/50 shadow-lg">
              <span className="text-sm font-bold text-indigo-700">{previews.length} {previews.length === 1 ? 'Image' : 'Images'}</span>
            </div>
          </div>
