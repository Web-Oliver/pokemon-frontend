    ...
    const renderSuggestionMetadata = useCallback(
      (suggestion: SearchSuggestion) => {
        ...
        if (suggestion.counts) {
          const totalItems =
            suggestion.counts.cards + suggestion.counts.products;
          metadata.push(
            <div
              key="counts"
      ...
      <div className="absolute top-full left-0 right-0 z-[9999] mt-3">
        ...
        <div className="relative z-[9999]">
          ...
          <div className="relative bg-black/40 backdrop-blur-3xl rounded-[1.5rem] shadow-2xl border border-white/10 ring-1 ring-white/5 overflow-hidden max-h-[500px]">
            ...
            <div
              className="absolute -bottom-4 -left-4 w-20 h-20 bg-gradient-to-br from-cyan-500/10 to-teal-500/10 rounded-full blur-xl animate-pulse"
                      ...
                      >
                        ...
                        <div className="relative z-10 flex items-center space-x-4">
                          ...
                          <div className="flex-1 min-w-0">
                            <h4
                              className={`text-sm font-semibold mb-1 ${isSelected ? 'text-white' : 'text-white/90'}`}
                            >
