  ...
  return (
    <div className="relative">
      ...
      <div className="relative">
        ...
        <div className="absolute -bottom-6 -left-6 w-24 h-24 bg-gradient-to-br from-purple-500/10 to-indigo-500/10 rounded-full blur-2xl animate-pulse" style={{animationDelay: '1s'}}></div>
        ...
        <div className="relative z-50">
          ...
          {errors.setName && (
            <div className="mt-3 p-3 bg-gradient-to-r from-red-500/20 to-pink-600/20 backdrop-blur-xl border border-red-500/30 rounded-xl shadow-lg flex items-center space-x-2">
              ...
              <p className="text-sm text-red-300 font-medium">{errors.setName.message}</p>
            </div>
          )}
      ...
      {activeField === 'setName' && suggestions.length > 0 && (
        <div className="absolute top-full left-0 right-0 z-[9999] mt-3" style={{top: '100%', left: '0', right: '50%'}}>
          {/* Background Glass Effects */}
          ...
          <div className="relative bg-black/40 backdrop-blur-3xl rounded-2xl shadow-2xl border border-white/10 ring-1 ring-white/5 overflow-hidden max-h-80">
            ...
            <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-gradient-to-br from-cyan-500/10 to-blue-500/10 rounded-full blur-lg animate-pulse" style={{animationDelay: '1s'}}></div>
          ...
          <div className="absolute top-full left-0 right-0 z-[9999] mt-3" style={{top: '100%', left: '0', right: '50%'}}>
            ...
            <div className="relative bg-black/40 backdrop-blur-3xl rounded-2xl shadow-2xl border border-white/10 ring-1 ring-white/5 overflow-hidden">
              <div className="p-8 text-center relative z-10">
                ...
                <p className="text-white/60 text-sm font-medium">Try adjusting your search terms</p>
              </div>
            </div>
          </div>
        )}
      ...
      {activeField === 'productName' && suggestions.length > 0 && (
        <div className="absolute top-full left-0 right-0 z-[9999] mt-3" style={{top: '100%', left: '50%', right: '0'}}>
          {/* Background Glass Effects */}
          ...
          <div className="relative bg-black/40 backdrop-blur-3xl rounded-2xl shadow-2xl border border-white/10 ring-1 ring-white/5 overflow-hidden max-h-80">
            ...
            <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-gradient-to-br from-indigo-500/10 to-violet-500/10 rounded-full blur-lg animate-pulse" style={{animationDelay: '1s'}}></div>
