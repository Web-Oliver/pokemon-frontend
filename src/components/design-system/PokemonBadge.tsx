...
export const PokemonBadge: React.FC<PokemonBadgeProps> = ({
  ...
  const getStyleClasses = (variant: string, style: string) => {
    const variants = {
      ...
      secondary: {
        solid: 'bg-slate-500/90 text-white border-slate-400/50 shadow-[0_2px_8px_0_rgb(71,85,105,0.3)]',
        outline: 'bg-transparent text-slate-400 border-slate-400/50 hover:bg-slate-400/10',
        glass: 'bg-slate-500/20 text-slate-200 border-slate-400/30 backdrop-blur-lg',
        minimal: 'bg-slate-500/10 text-slate-300 border-transparent'
      },
      success: {
        solid: 'bg-emerald-500/90 text-white border-emerald-400/50 shadow-[0_2px_8px_0_rgb(16,185,129,0.3)]',
        outline: 'bg-transparent text-emerald-400 border-emerald-400/50 hover:bg-emerald-400/10',
        glass: 'bg-emerald-500/20 text-emerald-200 border-emerald-400/30 backdrop-blur-lg',
        minimal: 'bg-emerald-500/10 text-emerald-300 border-transparent'
      },
      warning: {
        solid: 'bg-amber-500/90 text-white border-amber-400/50 shadow-[0_2px_8px_0_rgb(245,158,11,0.3)]',
        outline: 'bg-transparent text-amber-400 border-amber-400/50 hover:bg-amber-400/10',
        glass: 'bg-amber-500/20 text-amber-200 border-amber-400/30 backdrop-blur-lg',
        minimal: 'bg-amber-500/10 text-amber-300 border-transparent'
      },
      danger: {
        solid: 'bg-red-500/90 text-white border-red-400/50 shadow-[0_2px_8px_0_rgb(239,68,68,0.3)]',
        outline: 'bg-transparent text-red-400 border-red-400/50 hover:bg-red-400/10',
        glass: 'bg-red-500/20 text-red-200 border-red-400/30 backdrop-blur-lg',
        minimal: 'bg-red-500/10 text-red-300 border-transparent'
      },
      info: {
        solid: 'bg-blue-500/90 text-white border-blue-400/50 shadow-[0_2px_8px_0_rgb(59,130,246,0.3)]',
        outline: 'bg-transparent text-blue-400 border-blue-400/50 hover:bg-blue-400/10',  
        glass: 'bg-blue-500/20 text-blue-200 border-blue-400/30 backdrop-blur-lg',
        minimal: 'bg-blue-500/10 text-blue-300 border-transparent'
      },
      neutral: {
        solid: 'bg-zinc-500/90 text-white border-zinc-400/50 shadow-[0_2px_8px_0_rgb(113,113,122,0.3)]',
        outline: 'bg-transparent text-zinc-400 border-zinc-400/50 hover:bg-zinc-400/10',
        glass: 'bg-zinc-500/20 text-zinc-200 border-zinc-400/30 backdrop-blur-lg',
        minimal: 'bg-zinc-500/10 text-zinc-300 border-transparent'
      },
      gradient: {
        solid: 'bg-gradient-to-r from-cyan-500 via-purple-500 to-pink-500 text-white border-transparent shadow-[0_2px_8px_0_rgb(168,85,247,0.3)]',
    ...
    return variants[variant as keyof typeof variants]?.[style as keyof typeof variants.primary] || variants.primary.solid;
  };
