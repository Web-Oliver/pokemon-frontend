...
const SearchResultsCards: React.FC<SearchResultsCardsProps> = ({
  ...
  const renderResultStats = () => {
    if (!showResultStats || !results.length) return null;
              ...
              {searchMeta?.queryTime && (
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-green-700">{Math.min(searchMeta.queryTime, 9999)}ms</p>
                  </div>
                </div>
              )}
              ...
              {searchMeta?.hitRate && (
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-purple-700">{(searchMeta.hitRate * 100).toFixed(1)}%</p>
                  </div>
                </div>
              )}
            ...
            <div className="flex items-center space-x-4 mb-4">
              {result.pokemonNumber && (
                <div className="flex items-center">
                  ...
                  <span className="text-sm font-semibold text-gray-700">{result.pokemonNumber}</span>
                </div>
              )}
              ...
              {result.psaTotalGradedForCard > 0 && (
                <div className="flex items-center">
                  ...
                  <span className="text-sm font-semibold text-gray-700">{result.psaTotalGradedForCard.toLocaleString()}</span>
                </div>
              )}
            </div>
          </div>
        ...
        <div className="space-y-3 mb-6">
          ...
          {result.variety && (
            <div className="flex items-center p-3 bg-gradient-to-r from-yellow-50 to-orange-50 rounded-xl">
              ...
              <span className="text-sm font-semibold text-gray-800 ml-2 italic">{result.variety}</span>
            </div>
          )}
        </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-purple-700">{result.psaTotalGradedForCard.toLocaleString()}</p>
                </div>
              </div>
    ...
    <div className="text-center py-16 px-4">
      <div className="max-w-md mx-auto">
        ...
        <p className="text-gray-600 mb-6">
          We couldn't find any cards matching "<strong className="text-gray-900">{searchTerm}</strong>"
        </p>
