        ...
        >
          ...
          <div className='flex flex-col flex-1 space-y-2'>
            <div className='flex-1'>
              ...
              {item.setName && (
                <p className='text-xs text-slate-500 font-medium truncate mb-2'>{item.setName}</p>
              )}
            </div>
  ...
  if (items.length === 0) {
    return (
      <div className='py-12 text-center'>
        ...
        <p className='text-slate-600 font-medium'>Try adjusting your search or filter.</p>
      </div>
    );
  }
