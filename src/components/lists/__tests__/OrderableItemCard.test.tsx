...
describe('OrderableItemCard', () => {
  ...
  describe('rendering', () => {
    ...
    it('should render raw card correctly', () => {
      ...
      expect(screen.getByText('Raw Card - NM')).toBeInTheDocument();
  ...
  describe('selection functionality', () => {
    ...
    it('should apply selected styling when item is selected', () => {
      ...
      expect(cardElement).toHaveClass('ring-2', 'ring-blue-500', 'bg-blue-900/20');
    });
  });
