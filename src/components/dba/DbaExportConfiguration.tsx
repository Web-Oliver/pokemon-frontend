...
const DbaExportConfiguration: React.FC<DbaExportConfigurationProps> = React.memo(({
  selectedItems,
  customDescription,
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center mb-8">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-400">Configure your DBA.dk export</p>
            </div>
          </div>
          ...
          <div className="space-y-4">
                      ...
                      <div className="flex justify-center mb-6">
                        {item.images && item.images[0] ? (
                          ...
                          <div className="w-48 h-48 bg-zinc-700 rounded-lg border border-zinc-600 flex items-center justify-center">
                            <span className="text-zinc-500 text-xs text-center">No Image</span>
                          </div>
                        )}
                      </div>
            ...
            <div className="flex gap-3 pt-6 border-t border-zinc-700/50">
              <Button
                onClick={() => exportCollectionData(selectedItems, 'selected')}
