...
import { UnifiedHierarchicalSearch, PRODUCT_SEARCH_CONFIG } from './HierarchicalCardSearch';
...
const HierarchicalProductSearch: React.FC<HierarchicalProductSearchProps> = (props) => {
  return (
