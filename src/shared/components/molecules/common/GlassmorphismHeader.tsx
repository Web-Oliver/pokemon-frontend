...
const GlassmorphismHeader: React.FC<GlassmorphismHeaderProps> = ({
  ...
  return (
    <div
      className={`backdrop-blur-xl bg-gradient-to-br from-white/[0.15] via-cyan-500/[0.12] to-purple-500/[0.15] border border-white/[0.20] rounded-[2rem] shadow-2xl text-white p-12 relative overflow-hidden group ${className}`}
    >
